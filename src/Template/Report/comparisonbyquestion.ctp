...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-sm-10">
           <h4>Comparison by Others and Self By Each Question</h4>
        </div>
    </div>
    <div class="gab" style="height:30px"></div>
    <div class="" style="border: solid 0.1em;border-color: #bce8f1;padding: 45px 40px 40px 25px;">
        <div class="row">
            ...
            <div class="col-md-1">
                ...
                <br /><br />
                <a href="/report/excelExportByQuestion" onclick="location.href=this.href+'/'+document.getElementById('revlist').options[document.getElementById('revlist').selectedIndex].value+'/'+document.getElementById('emplist').options[document.getElementById('emplist').selectedIndex].value;return false;" class="button">Download</a>
            </div>
        </div>
        <div class="gab" style="height:30px"></div>
        <!-- ownertable -->
...
$(document).ready(function()
{
    ...
    function loadResult(review_id,emp_id)
    {
        ...
        $.ajax({              
              url: "<?php echo Router::url('/', true);?>report/getqcompareResult/"+review_id+"/"+emp_id,
              type: "POST"
            }).done(function(result)
            {
                if(result != '' || result != null)
                {  
                    ...
                    content += "<table id=\"ownertable\" cellspacing=\"0\" width=\"100%\" class=\"display dataTable\" name=\"display\"><thead><tr><th style='text-align:center'>No</th><th style='text-align:center'>Question</th><th style='text-align:center'>Others</th><th style='text-align:center'>Self</th><th style='text-align:center'>Different</th></tr></thead>";
