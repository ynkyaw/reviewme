...
<div id="page-wrapper">
    <div class="row">
        <div class="col-sm-12">
            <h4 class="page-header">New Single Item Review</h4>            
        </div>   
    </div>
    <!-- Start Of Form -->
                  ...
                  <div class="panel panel-primary">
                      ...
                      <div class="panel-body">
                        <div class="row">  
                            ...
                            <div class="col-sm-4">
                              <?=   
                                $this->Form->input('revieweeid',['id'=>'myreviewers','options' => $productlist,'class'=>'form-control','label'=>false,'required'])
                                ?>
                            </div> 
                        </div>
                        <hr/>                     
  ...
  var projectlist;
    ...
    $(document).ready(function() 
    {
      ...
      if(!CheckValidation())
      {
        ...
        servicelist = <?php echo json_encode($servicelist); ?>;
        productlist = <?php echo json_encode($productlist); ?>;
        projectlist = <?php echo json_encode($projectlist); ?>;
    });
    ...
    $("#revtype").change(function (e) 
    {
        ...
        else if($(this).find(':selected').val() == 6)
        {
            ...
            var itemname = document.getElementById('itemname');
            $('#itemname').empty();
            itemname.innerHTML = "Project"; 

            var itemtitle = document.getElementById('itemtitle');
            $('#itemtitle').empty();
            itemtitle.innerHTML = "Project";    
        }
        else if($(this).find(':selected').val() == 7)
        {
            ...
            var itemname = document.getElementById('itemname');
            $('#itemname').empty();
            itemname.innerHTML = "Service";

            var itemtitle = document.getElementById('itemtitle');
            $('#itemtitle').empty();
            itemtitle.innerHTML = "Service"; 
        }
    });
