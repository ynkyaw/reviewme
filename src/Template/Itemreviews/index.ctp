...
<div id="page-wrapper">
    <div class="row">
        <div class="col-sm-12">
            <h4 class="page-header">Item Review List (Product,Project,Service)</h4>
        </div>                     
    </div>
    <div class="row">
        <div class="col-sm-12">
        ...
        <div class="col-sm-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <div class="row">
                        <div class="col-sm-10">
                            <a style="color: white;" data-toggle="collapse" data-target="#demo">Single Item Review List </a>
                        </div>
                    ...
                    <div class="panel-body">
                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover" >
                            ...
                            <tbody>
                                ...
                                {
                                    $i = 0;
                                    foreach ($itemreviews->result as $td)
                                    {
