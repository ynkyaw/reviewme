                    ...
                    <?= $this->Form->create($rank,array('onsubmit' => 'return confirm("Are you sure you want to save?")')) ?>
                        <fieldset>
                            <div class="form-group">
                                ...
                                <?= $this->Form->input('rank',['class'=>'form-control','label'=>false]) ?>
                            </div>
                            <div class="form-group">
                                <label for="rankdescription">Rank Description</label>
                                <?= $this->Form->input('description',['class'=>'form-control','type' => 'textarea','label'=>false,'required','onchange'=>'CheckRankName(this)']) ?>
                            </div>
                            <div class="form-group" style="floating:right">
                                <label for="level">Rank Level</label><label style="color:red;font-size:18px;">*</label>
                                <?= $this->Form->input('level',['class'=>'form-control','label'=>false,'required','onchange'=>'CheckRankDescription(this)']) ?>
                            </div>
