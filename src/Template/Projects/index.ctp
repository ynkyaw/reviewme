...
<div id="page-wrapper1" style="margin: 0 0 0 290px;width:1000px;">
    ...
    <div class="row" style="margin-bottom: 10px;">
        ...
        <div class="col-sm-2" style="padding-top: 0px;">
            <a href="projects/add" class="btn btn-primary btn-circle btn-lg" style="color: white;width: 80px;padding-top: 0.7em;margin-top: -1em">                
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="actions">
                                        ...
                                        &nbsp;&nbsp;&nbsp;
                                        <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $project->id], ['confirm' => __('Are you sure you want to delete rank : {0}?', $project->projectname),'style'=>'color:red']) ?>
                                    </td>
                                </tr>
                                <?php endforeach; 
                            }
