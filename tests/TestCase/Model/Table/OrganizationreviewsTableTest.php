...
use App\Model\Table\OrganizationreviewsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\OrganizationreviewsTable Test Case
 */
class OrganizationreviewsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\OrganizationreviewsTable
     */
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Organizationreviews') ? [] : ['className' => 'App\Model\Table\OrganizationreviewsTable'];
        $this->Organizationreviews = TableRegistry::get('Organizationreviews', $config);
    }
    ...
    {
        unset($this->Organizationreviews);
