...
use App\Model\Table\OrganizationreviewsQuestionTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\OrganizationreviewsQuestionTable Test Case
 */
class OrganizationreviewsQuestionTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\OrganizationreviewsQuestionTable
     */
    public $OrganizationreviewsQuestion;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('OrganizationreviewsQuestion') ? [] : ['className' => 'App\Model\Table\OrganizationreviewsQuestionTable'];
        $this->OrganizationreviewsQuestion = TableRegistry::get('OrganizationreviewsQuestion', $config);
    }
    ...
    {
        unset($this->OrganizationreviewsQuestion);
