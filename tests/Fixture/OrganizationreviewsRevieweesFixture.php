...
/**
 * OrganizationreviewsRevieweesFixture
 *
 */
class OrganizationreviewsRevieweesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['organizationreviews_id', 'revieweeid'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
