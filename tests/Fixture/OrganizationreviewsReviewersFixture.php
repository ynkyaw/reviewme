...
/**
 * OrganizationreviewsReviewersFixture
 *
 */
class OrganizationreviewsReviewersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['organizationreviews_id', 'reviewerid'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
