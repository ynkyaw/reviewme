...
/**
 * OrganizationreviewsFixture
 *
 */
class OrganizationreviewsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'goal' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
